...
class Bot:
    ...
    def auth_args(self):
        if not hasattr(self, '_auth_args'):
            ...
            if self.app_secret is not None:
                appsecret_proof = fbm_utils.generate_appsecret_proof(self.access_token, self.app_secret)
    ...
    def send_quick_replies_messages(self, recipient_id, text, quick_replies):
        ...
        self.send_raw(data)
# fb = Bot("EAAUSZCuERiN4BANldm4UztMq7otNv5K7HRGA1rL9T76F4CVAqIPuAMWzZB1nwanK8bTpAuEuThECfB4jpW9jV9FNWQZCNfiNP3DEDyA5rCKoC6qgnzxEphpm5Pf1aQf5uE21SpKa0Dcmqdxie4e7GsgIQbyjDswwgpebI6JKQZDZD")
# # fb.send_text_message(1455048691184670, 'test')
# profile = fb.get_user_info(1455048691184670, fields=['first_name','last_name','profile_pic','locale','timezone','gender'])
# fb.send_raw({"recipient":{"id":"1455048691184670"},"message":{"text":"Please share your location:","quick_replies":[{"content_type":"location"}]}})